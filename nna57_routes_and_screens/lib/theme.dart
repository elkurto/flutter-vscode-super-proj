...
ThemeData primaryTheme = ThemeData(
  ...
  // card theme
  // cardTheme: CardTheme(  // CardTheme is deprecated, so just style :widget:Card (:file:./screens/home/character_card.dart)
  ...
  inputDecorationTheme: InputDecorationTheme(
    filled: true,
    // fillColor: AppColors.secondaryColor.withOpacity(0.5), // deprecated; use .withValues or .withAlpha
  ...
  dialogTheme: DialogThemeData(
    ...
    surfaceTintColor: AppColors.secondaryAccent, // remove red tint
  ),
);
