...
/*
 Based on go_router's transition example
 (see https://github.com/flutter/packages/blob/main/packages/go_router/example/lib/transition_animations.dart)

 
 (idiomatic) To use a custom transition animation, provide a `pageBuilder` with a  CustomTransitionPage.

 animation in Flutter, check out the [Introduction to
 animations](https://docs.flutter.dev/development/ui/animations) page on
 flutter.dev.
 
 This app contains a home, details, and custom page.
 Additionally this example shows a overlay dialog.
 Basicially Transitions have duration, direction, opacity.
