...
// AppColors is just an arbitrary PODO
// AppColors names reusable colors in :ThemeData:"primaryTheme" (see below)
class AppColors {
...
ThemeData primaryTheme = ThemeData(
  ...
  appBarTheme: AppBarTheme(
    ...
    surfaceTintColor: Colors.transparent, // hide surfaceTintColor
    centerTitle: true,
  ),
